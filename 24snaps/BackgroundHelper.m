...
+(void)calculateNextNumber
{
    ...
    {
        NSLog(@"Result: %@", [NSString stringWithFormat:@"Position %d = %@", self.sharedBackgroundHelper.position, self.sharedBackgroundHelper.current]);
    }
    else
    {
        ...
        NSLog(@"App state is %@. Next number = %@", stateString, [NSString stringWithFormat:@"Position %d = %@", self.sharedBackgroundHelper.position, self.sharedBackgroundHelper.current]);
